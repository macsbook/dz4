...
var numberUser = document.querySelector(".number-user");
var numberComp = document.querySelector(".number-comp");
...
function counter () {
    numberUser.innerHTML = winnerScore[0]
    numberComp.innerHTML = winnerScore[1]
}
counter()